        ...
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-white">
            <div class="overflow-hidden rounded-3xl bg-gray-900 shadow-2xl shadow-black/40 text-white">
                <div class="p-8 text-white">
                    ...
                    <form action="{{ route('tasks.update', $task) }}" method="POST" class="space-y-6 text-white">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                class="w-full rounded-2xl bg-gray-800 px-4 py-3 text-white placeholder:text-gray-400 outline-none ring-1 ring-gray-700 transition focus:ring-2 focus:ring-cyan-500">{{ old('description', $task->description) }}</textarea>
                        </div>
